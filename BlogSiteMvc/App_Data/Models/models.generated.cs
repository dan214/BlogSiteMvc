...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "ff4a9c16db970e27")]
...
#pragma warning restore 0109
	...
	[PublishedContentModel("personal")]
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<Personal, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
